/*
questo programma riceve parametri da linea di comando e restituisce i numeri inseriti in lettere
es:
	go run main.go 12 300 209  --> OneTwo ThreeZeroZeroTwoZeroNine
*/
package main
